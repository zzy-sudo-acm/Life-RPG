  ...
  return (
    <div className="space-y-7">
      <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div><h1 className="text-3xl font-semibold tracking-tight text-ink">角色</h1><p className="mt-2 text-sm text-muted">这里集中展示成长反馈；日常无需手动维护数值。</p></div>
        ...
        <div className="flex flex-col gap-5 sm:flex-row sm:items-center">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex flex-wrap items-baseline justify-between gap-2">
              <div><h2 className="text-2xl font-semibold tracking-tight text-ink">{data.character.name}</h2><p className="mt-1 text-sm text-muted">{data.character.profession} · {data.character.lifeStage}</p></div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <section aria-labelledby="skills-heading">
          <div className="mb-3"><h2 id="skills-heading" className="flex items-center gap-2 text-xl font-semibold tracking-tight text-ink"><BookOpen size={19} className="text-muted" /> 技能</h2><p className="mt-1 text-xs text-faint">完成同分类任务时自动成长</p></div>
        ...
        <section aria-labelledby="stats-heading">
          <div className="mb-3"><h2 id="stats-heading" className="flex items-center gap-2 text-xl font-semibold tracking-tight text-ink"><TrendingUp size={19} className="text-muted" /> 五维属性</h2><p className="mt-1 text-xs text-faint">分类决定任务主要成长方向</p></div>
      ...
      <section aria-labelledby="achievements-heading">
        <div className="mb-3"><h2 id="achievements-heading" className="flex items-center gap-2 text-xl font-semibold tracking-tight text-ink"><Award size={19} className="text-muted" /> 成就</h2><p className="mt-1 text-xs text-faint">重要节点会自动解锁并写入成长足迹</p></div>
      ...
      <section aria-labelledby="footprint-heading">
        <div className="mb-3 flex items-end justify-between gap-3"><div><h2 id="footprint-heading" className="flex items-center gap-2 text-xl font-semibold tracking-tight text-ink"><Footprints size={19} className="text-muted" /> 成长足迹</h2><p className="mt-1 text-xs text-faint">只记录目标、成就、阶段和主动添加的重要事件</p></div><Button variant="ghost" className="min-h-9 px-3" icon={<Plus size={14} />} onClick={() => setEventEditor('new')}>重要事件</Button></div>
